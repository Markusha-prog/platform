...
class Group(models.Model):
    ...
    slug = models.SlugField('Ссылка на группу', max_length=70, null=True)
...
class Team(models.Model):
    ...
    team_case = models.ForeignKey(Hackathon, on_delete=models.SET_NULL, verbose_name='Кейс для команды', blank=True,
                                  null=True)
    rating_team = models.BigIntegerField(verbose_name='Глобальный рейтинг команды', blank=True, null=True)
    estimation_team = models.BigIntegerField(verbose_name='Оценка за текущей хакатон', blank=True, null=True)
    slug = models.SlugField('Ссылка на команду участника', max_length=70, null=True)
...
class Profile(models.Model):
    ...
    rating_user = models.BigIntegerField(verbose_name='Глобальный рейтинг пользователя', blank=True, null=True)
    estimation_user = models.BigIntegerField(verbose_name='Оценка за текущей хакатон', blank=True, null=True)
    points = models.BigIntegerField(verbose_name='Балы организатора или спонсора', blank=True, null=True)
